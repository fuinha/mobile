...
class AddCustomEventScreen extends StatefulWidget {
  @override
  _AddCustomEventScreenState createState() => _AddCustomEventScreenState();
}

class _AddCustomEventScreenState extends State<AddCustomEventScreen> {
